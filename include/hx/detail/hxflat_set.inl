...
hxinline hxattr_flatten hxflat_set<key_t_, capacity_, compare_t_, traits_>::hxflat_set(void)
	: m_end_(this->data()) {
}

template<hxflat_set_concept_ key_t_, hxsize_t capacity_, typename compare_t_, int traits_>
hxinline hxattr_flatten hxflat_set<key_t_, capacity_, compare_t_, traits_>::hxflat_set(const hxflat_set& x_) noexcept
	: m_end_(this->data()) {
	this->operator=(x_);
}
...
template<hxflat_set_concept_ key_t_, hxsize_t capacity_, typename compare_t_, int traits_>
hxinline hxflat_set<key_t_, capacity_, compare_t_, traits_>::hxflat_set(hxflat_set&& x_) noexcept {
...
template<hxflat_set_concept_ key_t_, hxsize_t capacity_, typename compare_t_, int traits_>
hxinline hxattr_flatten hxflat_set<key_t_, capacity_, compare_t_, traits_>::~hxflat_set(void) noexcept {
	this->clear();
}
...
hxinline hxattr_flatten auto hxflat_set<key_t_, capacity_, compare_t_, traits_>::and_then(
...
template<hxflat_set_concept_ key_t_, hxsize_t capacity_, typename compare_t_, int traits_>
hxinline hxattr_flatten void hxflat_set<key_t_, capacity_, compare_t_, traits_>::operator=(
...
template<hxflat_set_concept_ key_t_, hxsize_t capacity_, typename compare_t_, int traits_>
hxinline hxattr_flatten auto hxflat_set<key_t_, capacity_, compare_t_, traits_>::operator[](
...
template<hxflat_set_concept_ key_t_, hxsize_t capacity_, typename compare_t_, int traits_>
hxinline hxattr_flatten void hxflat_set<key_t_, capacity_, compare_t_, traits_>::clear(void) noexcept {
...
template<hxflat_set_concept_ key_t_, hxsize_t capacity_, typename compare_t_, int traits_>
hxinline hxattr_flatten hxsize_t hxflat_set<key_t_, capacity_, compare_t_, traits_>::count(const key_t_& key_) const {
...
hxinline hxattr_flatten auto hxflat_set<key_t_, capacity_, compare_t_, traits_>::emplace(
...
template<hxflat_set_concept_ key_t_, hxsize_t capacity_, typename compare_t_, int traits_>
hxattr_flatten hxsize_t hxflat_set<key_t_, capacity_, compare_t_, traits_>::erase(const key_t_& key_) noexcept {
	const compare_t comp_;
	key_t_* end_ = m_end_;
	hxif_constexpr((traits_ & hxtrait_multi) == 0) {
...
template<hxflat_set_concept_ key_t_, hxsize_t capacity_, typename compare_t_, int traits_>
hxinline hxattr_flatten auto hxflat_set<key_t_, capacity_, compare_t_, traits_>::erase(const key_t_* it_) noexcept -> const key_t_* {
...
template<hxflat_set_concept_ key_t_, hxsize_t capacity_, typename compare_t_, int traits_>
hxinline hxattr_flatten bool hxflat_set<key_t_, capacity_, compare_t_, traits_>::has_value(
...
hxflat_set<key_t_, capacity_, compare_t_, traits_>::keys(void) const noexcept {
	return this->data();
}
...
template<hxflat_set_concept_ key_t_, hxsize_t capacity_, typename compare_t_, int traits_>
template<typename self_t_, typename callable_t_>
hxinline hxattr_flatten auto hxflat_set<key_t_, capacity_, compare_t_, traits_>::or_else(
		this self_t_&& self_, const key_t_& key_, callable_t_&& callable_)
		-> decltype(self_.end()) {
...
template<hxflat_set_concept_ key_t_, hxsize_t capacity_, typename compare_t_, int traits_>
hxinline hxattr_flatten void hxflat_set<key_t_, capacity_, compare_t_, traits_>::swap(
		hxflat_set& x_) noexcept {
	static_assert(capacity_ == hxallocator_dynamic_capacity,
...
template<hxflat_set_concept_ key_t_, hxsize_t capacity_, typename compare_t_, int traits_>
hxinline hxattr_flatten auto hxflat_set<key_t_, capacity_, compare_t_, traits_>::upper_bound(const key_t_& key_) const
		-> const key_t_* {
	const compare_t comp_;
...
hxinline hxattr_flatten key_t_ hxflat_set<key_t_, capacity_, compare_t_, traits_>::value_or(
