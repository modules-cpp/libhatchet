...
template<hxfree_list_concept_ T_, hxsize_t capacity_>
hxinline hxattr_flatten hxfree_list<T_, capacity_>::hxfree_list(hxfree_list&& x_) noexcept {
...
template<hxfree_list_concept_ T_, hxsize_t capacity_>
hxinline hxattr_flatten hxsize_t hxfree_list<T_, capacity_>::capacity(void) const {
...
template<hxfree_list_concept_ T_, hxsize_t capacity_>
hxinline hxattr_flatten void hxfree_list<T_, capacity_>::enqueue_all_(hxsize_t count_) noexcept {
